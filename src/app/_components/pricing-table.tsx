...
export function ProductCard({
	...
	if (product.active) {
		return (
			<div
				className={`p-10 border-2 rounded-md hover:cursor-pointer ${
					selectedPlan.plan === product.productId
						? "-translate-y-2"
						: "hover:-translate-y-2"
				} transition-all w-full max-w-[21rem] min-h-[22rem] `}
	...
	return (
		<>
			<div className="flex mb-6 m-auto">
				<div
					className="px-5 py-2 border m-2 hover:cursor-pointer"
